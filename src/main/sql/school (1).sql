...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 23, 2024 lúc 08:27 AM
...
ALTER TABLE `course`
  ...
  ADD KEY `FK_COURSEvsDEPARTMENT` (`DepartmentID`);
...
ALTER TABLE `courseinstructor`
  ...
  ADD KEY `FK_courseinstructortvsperson` (`PersonID`);
...
ALTER TABLE `studentgrade`
  ...
  ADD KEY `fk_llk` (`StudentID`),
  ADD KEY `FK_StudentGradevsCourse` (`CourseID`);
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `FK_COURSEvsDEPARTMENT` FOREIGN KEY (`DepartmentID`) REFERENCES `department` (`DepartmentID`);

--
-- Các ràng buộc cho bảng `courseinstructor`
--
ALTER TABLE `courseinstructor`
  ADD CONSTRAINT `FK_courseinstructortvscourse` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`),
  ADD CONSTRAINT `FK_courseinstructortvsperson` FOREIGN KEY (`PersonID`) REFERENCES `person` (`PersonID`);

--
-- Các ràng buộc cho bảng `officeassignment`
--
ALTER TABLE `officeassignment`
  ADD CONSTRAINT `FK_officeassignmentvsperson` FOREIGN KEY (`InstructorID`) REFERENCES `person` (`PersonID`);

--
-- Các ràng buộc cho bảng `onlinecourse`
--
ALTER TABLE `onlinecourse`
  ADD CONSTRAINT `FK_ONLINECOURSEvsCOURSE` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`),
...
--
ALTER TABLE `onsitecourse`
  ADD CONSTRAINT `FK_ONSITECOURSEvsCOURSE` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`);

--
-- Các ràng buộc cho bảng `studentgrade`
--
ALTER TABLE `studentgrade`
  ADD CONSTRAINT `FK_StudentGradevsCourse` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`),
  ADD CONSTRAINT `fk_llk` FOREIGN KEY (`StudentID`) REFERENCES `person` (`PersonID`);
COMMIT;
